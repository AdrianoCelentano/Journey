...
2. **Implement Feedback**: Make the required code changes to the source code to address the PR comments.
...
5. **Update Documentation**: If necessary, create or update Markdown files inside the `/docs` folder of the main repository. synchronization to the wiki is handled automatically by a GitHub Action.
...
6. **Push Changes**: Push your updated commits (code and documentation) up to the existing branch of the PR using Git (`git push`) so that the pull request updates automatically.
